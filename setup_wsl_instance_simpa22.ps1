...
$instanceName = "Ubuntu-22.04-Simpa"
$imageFile = "ubuntu-jammy-wsl-amd64-wsl.rootfs.tar.gz"
$envScriptName="install_ardupilot_ros2-humble_gazebo-harmonic.sh"
$imageUrl = "https://cloud-images.ubuntu.com/wsl/releases/22.04/current/ubuntu-jammy-wsl-amd64-wsl.rootfs.tar.gz"

$basePath = "c:\Simpa"
$wslPath = "$basePath\wsl"
$installPath = "$wslPath\$instanceName"
$imagePath = "$wslPath\$imageFile"
$envScriptPathWin = "$basePath\scripts\simpa22\*sh"
$envScriptPathMnt = "/mnt/c/Simpa/scripts/simpa22/*.sh"
